          ...
          <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-sm border border-line dark:border-white/5 p-8">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 bg-emerald-50 dark:bg-emerald-900/30 rounded-sm flex items-center justify-center text-emerald-600">
                  <Shield size={24} />
                </div>
            ...
            <div className="bg-surface rounded-sm p-8 text-white">
              <div className="flex items-center gap-4 mb-6">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={item.step} className="flex gap-4">
                    <span className="text-xs font-semibold text-blue-400 mt-1">{item.step}</span>
                    <div>
          ...
          <div id="report-form" className="bg-white dark:bg-slate-900 rounded-sm p-10 md:p-12 border border-line dark:border-white/5">
            ...
            {submitted ? (
              <div className="text-center py-12">
                <div className="w-20 h-20 bg-emerald-50 dark:bg-emerald-900/30 rounded-sm flex items-center justify-center mx-auto mb-6 text-emerald-600 shadow-inner">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <label className="flex items-center gap-3 cursor-pointer p-4 bg-amber-50 dark:bg-amber-900/10 rounded-sm border border-amber-100 dark:border-amber-900/30">
                  <input
                    type="checkbox"
                  ...
                  />
                  <span className="text-xs font-semibold text-amber-900 dark:text-amber-400 uppercase tracking-widest">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full bg-amber-500 text-[#0A1128] font-semibold uppercase tracking-widest py-5 rounded-sm hover:bg-amber-400 transition-all disabled:opacity-50 inline-flex items-center justify-center gap-3"
                >
                  {submitting ? (
                    <>
